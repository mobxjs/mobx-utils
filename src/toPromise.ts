...
/**
 * Creates a Promise that resolves with an observed value when fulfills the conditions of a predicate.
 *
 ...
 * @returns a Promise that resolves with the observed value when fulfills the conditions of the predicate
 */
